...
void Partenaire::Contract_to_Pdf(QString nom, QString date,QString lieu, QString contenu,QString header,QString partner)
{
    ...
    QString html = "<div align=center><img src='../Smart_Contracting_And_Construction_Company_2A2/logo.png' widht='100' height='100'></div><div align=right>";
    html += lieu+", "+date+"</div><div align=left>"+nom+"</div><h1 align=center>"+header+"</h1><br><br><div align=left><b>"+partner+"</b></div><p align=justify>"+contenu+"</p><br><br><div align=left>Cordialement<br>Architech</div><div align=right>Signature</div><div align=right><img src='../Smart_Contracting_And_Construction_Company_2A2/signature.png' width='100' height='100'></div>";
    ...
    printer.setOutputFileName("../Smart_Contracting_And_Construction_Company_2A2/contrat.pdf");
...
QString Partenaire::translate()
{
    QObject *parent = NULL;
               ...
               myProcess->start("cmd /C python ../Smart_Contracting_And_Construction_Company_2A2/translate.py");
               ...
               string end_result="";
               fstream Translated("../Smart_Contracting_And_Construction_Company_2A2/translated.txt",ios::in);
...
QString Partenaire::recommand()
{
    QObject *parent = NULL;
               QProcess *myProcess = new QProcess(parent);
               myProcess->start("cmd /C python ../Smart_Contracting_And_Construction_Company_2A2/recommend.py");
               myProcess->write("exit\n\r");
               myProcess->waitForFinished();
               myProcess->close();
               ...
               string recommended;
               string end_result="";
               fstream chosen("../Smart_Contracting_And_Construction_Company_2A2/recommend.txt",ios::in);
